...
- The cart / budget indicator was originally designed as a vector icon, I replaced it with a real text-based budget value to improve clarity and usability. This required extra work to properly adjust:
    *  Text size
    *  Budget container size
    *  Positioning (placed above the cart button)

- Additionally:
 The original design did not include a mobile navigation state, A burger menu icon was present, but no menu layout or interaction was provided after clicking it To ensure full responsiveness:
