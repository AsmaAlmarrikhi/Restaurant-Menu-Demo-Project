...
export const HomeAboutUSSection = () => {
    return (
        <div className="relative flex flex-col items-center justify-center mx-[20px] lg:mx-[135px] gap-[20px] lg:gap-[70px] h-fit">
            <div className="flex flex-col gap-[16px] w-full lg:w-[820px]">
                <h4 className="font-bold text-[28px] lg:text-[50px] text-center">
                    Why We are Best Food Maker
                </h4>
                <p className="text-[14px] lg:text-[20px] text-center">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem scrambled it to make a type specimen book.
                </p>
            </div>
