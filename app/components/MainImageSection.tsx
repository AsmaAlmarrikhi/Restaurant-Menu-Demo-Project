...
export const MainImageSection = () => {
   return (  <div className="w-[100vw] h-[100vh]">
        ...
        width={2000}
        height={2000}
        className="absolute w-full h-full = top-[0px] lg:top-[62px] -z-100 object-cover "
        />
        <div className="bg-black opacity-60 w-full h-full absolute -z-99 top-[0px] lg:top-[62px] "></div>
        {/* Text Div */}
